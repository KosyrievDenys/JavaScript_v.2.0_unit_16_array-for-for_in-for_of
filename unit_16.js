...
function f1() {
	...
	document.querySelector('.out-1').textContent = q;
}
...
function f2() {
	...
	document.querySelector('.out-2').textContent = q;
}
...
function f4() {
	let div = document.querySelectorAll('div.out-4');
	for (let item of div) {
		item.innerHTML += 4;
	}
}
...
function f6() {
	...
	document.querySelector('.out-6').textContent = q;
}
...
function f9() {
	...
	for (let i = 0; i < a9.length; i++) {
		if (q < a9[i].length) q = a9[i].length - 1;
	}
	console.log(q);
	return q;
...
function f11() {
	...
	document.querySelector('.out-11').textContent = q;
}
...
function f12() {
	...
	document.querySelector('.out-12').textContent = q;
}
...
function f13() {
	...
	document.querySelector('.out-13').textContent = q;
}
...
function f14() {
	...
	document.querySelector('.out-14').textContent = q;
}
